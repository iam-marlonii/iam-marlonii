...
INFO = [
    ("__header__", "marlon ausby ii", ""),
    ("__rule__", "", ""),
    ("__blank__", "", ""),
    ("Role",     "CRM Operations Architect @ My Well", "val"),
    ("Also",     "Founder · The 7th Lab", "val"),
    ("Edu",      "BS Biomedical Sciences · USF", "val"),
    ("Focus",    "Fintech · Payments · CRM · Cloud", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "TypeScript · Python · Go · SQL", "val"),
    ("Web",      "Next.js · React · Astro · Tailwind", "val"),
    ("Data",     "PostgreSQL · MySQL · Supabase", "val"),
    ("Cloud",    "AWS · Docker · Proxmox · Terraform", "val"),
    ("Pay",      "Stripe · PCI DSS · Vaulted Data", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("CRM.1",     "crm-dot-one — The minimalist's CRM", "warn"),
    ("GoFomu",    "go-fomu — The minimalist's form builder", "warn"),
    ("marlon_ii", "marlonii.com — My robust Astro portfolio site", "warn"),
    ("Docs.1",    "links.marlonii.com — The minimalist's Docs CMS", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Impact",   "PCI migrations · 100K+ payment methods", "val"),
    ("",         "99.3% accuracy · $1.3B+ annual volume", "muted"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/contact", ""),
    ("Web",      "marlonii.com", "accent"),
    ("In",       "linkedin.com/in/marlon-ausby-jr", "accent"),
...
# RENDER
# ----------------------------------------------------------------------------
def render(theme_name, colors, stats, stamp):
...
def main():
    ...
    stamp = et.strftime("%d %b %Y, %H:%M ET")
