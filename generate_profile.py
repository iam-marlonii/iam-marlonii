...
INFO = [
    ...
    ("todo",     "terminal-list — Go TUI task board", "warn"),
    ("career",   "career-agent — job hunt framework", "warn"),
    ("web",      "marlonii.com — Astro portfolio", "warn"),
    ("links",    "links.marlonii.com — social hub", "warn"),
    ("__blank__", "", ""),
